...
Para marcar ímãs (abas Frente e Perfil, 6 partes à esquerda e prévia à direita) ou incluir um Freak novo a partir de uma folha com 6+6 partes: **Project → Tools** (Ímãs das Peças / Incluir personagem). Passo a passo em [docs/tecnico/incluir-personagem.md](docs/tecnico/incluir-personagem.md).
