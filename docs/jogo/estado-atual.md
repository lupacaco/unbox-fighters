...
| Tela de luta | Um contra um no palco: pulo na mola, dois pulos até o ataque (base sai do chão junto, sombra + recorte escuro na madeira), o kit vencedor voa até a peça do outro (empate: os dois batem no centro), KO. Nomes/HP/VS ficam inteiros no topo. Peça destruída voa para fora da tela. Ordem de frente: cabeça, braço D, tronco, braço E |
...
| Visual composto | Base-mola em toda carta (menor que as peças; solta vazia, pressionada com peça). Ímãs unem cabeça e tronco pelas esferas; cada braço cola no ombro. Na frente os braços abrem um pouco |
