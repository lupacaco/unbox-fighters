...
| Luta em fila | Choque de kits sorteados (pode misturar cabeça vs pernas), só o vencedor ataca, cópia das cartas, teto de 12 de dano por Freak |
| Tela de luta | Um contra um no palco: pulo, andar afastados, o kit vencedor voa até a peça do outro, KO. Peça destruída voa para fora da tela. Ordem de frente: cabeça, braço D, tronco, perna D, perna E, braço E |
