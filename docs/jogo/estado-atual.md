...
| Tela de luta | Um contra um no palco: pulo na mola, andar em pulinhos (base sai do chão junto), o kit vencedor voa até a peça do outro (empate: os dois batem no centro), KO. Nomes/HP/VS ficam inteiros no topo. Peça destruída voa para fora da tela. Ordem de frente: cabeça, braço D, tronco, braço E |
