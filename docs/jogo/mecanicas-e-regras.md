...
- Na esteira (e na carta) o **caixote** mostra Ataque (punho) e HP (coração). O HP cai na luta. Verde = acima da ficha, vermelho = abaixo, branco = igual. Sem set completo o nome é **FREAK**; com set completo, o nome do Freak.
