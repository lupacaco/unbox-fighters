...
- **Esteira azul** embaixo à esquerda, **vermelha** à direita, vão no meio; os Freaks param em cima dos rolos; dois na mesma esteira ficam com espaço entre os caixotes
...
- `CharacterSlot` — recebe 2 kits; o caixote (duas partes) já está na carta (mesmo tamanho vazio ou com peças); **LUTAR** aparece quando está completo (cartas do oponente não têm LUTAR e não aceitam o seu arraste)
- `BeltFreak` — o Freak na esteira: pula da carta com o braço para a frente, rema 5 vezes em meia-lua; o caixote mostra Ataque, HP e o nome
