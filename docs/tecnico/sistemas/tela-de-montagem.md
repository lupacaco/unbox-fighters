...
- `CharacterSlot` — recebe 2 kits em cima da base-mola (não sai da carta; mola um pouco menor, Freak mais baixo, sombra no chão); o rótulo da fila arrasta o Freak inteiro  
