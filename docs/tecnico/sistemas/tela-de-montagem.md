...
- `CharacterSlot` — recebe 2 kits; o caixote já está na carta; **LUTAR** aparece quando está completo (cartas do oponente não têm LUTAR e não aceitam o seu arraste)
