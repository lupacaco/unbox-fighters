...
Na **carta** e na **esteira** o corpo mostra **três desenhos** (tronco, braço E e braço D), para cada braço poder se mexer. No **retângulo preto** do caixote aparecem o nome, o Ataque (punho) e o HP (coração).
...
4. Braços: esfera de cima cola nos ombros. Na **frente**, os braços abrem um pouco, girando nesse ímã (não soltam). Na carta, os braços ficam **na frente** da caixa. Na esteira, os braços ficam **esticados para a frente** e **na frente** dos números do caixote; a cabeça fica **na frente** do tronco.
