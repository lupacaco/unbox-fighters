...
Todos em **200×200**. No jogo o tamanho fica 1:1 (não estica). A mola fica em `assets/objects/base-mola-solta.png` e `base-mola-pressionada.png` (300×300), **menor** que as peças, com uma sombra oval no chão. Na luta, embaixo da sombra, um recorte mais escuro na madeira da prateleira.
