...
3. **Anda** de perfil, pulando de verdade. Cada pulo: a mola **aperta** no chão, **impulsiona** e o brinquedo inteiro (base + Freak) **sai do chão** num arco; no ar a mola fica **solta**; ao cair, aperta de novo. Uma **sombra oval** fica no chão da mola (encolhe um pouco no ar). Parado, a mola fica pressionada. Braços e cabeça acompanham. Os dois do duelo ficam **na mesma altura do chão** e do **mesmo tamanho**.
