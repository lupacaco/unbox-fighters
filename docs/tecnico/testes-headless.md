...
| `verify_fight_line.gd` | Fila no mesmo chão; pulo na mola; duelistas afastados; placas de HP cabem no topo |
| `verify_thrown_kit.gd` | Kit copiado do boneco some do corpo e pode voltar |
| `verify_fight_poses.gd` | Personagem tem perfil; carta aceita cabeça e tronco, recusa pernas |
