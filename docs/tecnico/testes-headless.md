...
| `verify_belt.gd` | 5 remadas de 2 s até a ponta, braço para a frente e meia-lua para trás, fila de 2 com espaço entre os caixotes, 50 de chip a partir do 0 vence |
