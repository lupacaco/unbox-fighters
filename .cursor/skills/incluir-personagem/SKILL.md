...
- Não deixe de marcar os ímãs na ferramenta **Project → Tools → Ímãs das Peças** (as 12 partes na mesma tela, frente e perfil). Não chute X = 0.
...
2. Medir ímãs com **Project → Tools → Ímãs das Peças**: escolha o Freak e marque as **12 partes na mesma tela** (frente em cima, lado embaixo). Arraste cada bolinha até a esfera de metal. No tronco são 5 (pescoço, ombros, quadris). Não marque o kit `*_legs.tres`.
